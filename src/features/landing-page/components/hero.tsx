...
export function Hero() {
  return (
    <section className="from-primary/10 to-background w-full bg-gradient-to-b py-12 md:py-24 lg:py-32">
      <div className="container mx-auto my-0 px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[1fr_600px] lg:gap-12 xl:grid-cols-[1fr_700px]">
          ...
          <div className="flex items-center justify-center">
            <div className="bg-background relative w-full max-w-[600px] overflow-hidden rounded-lg border shadow-xl">
              <Image
                ...
                priority
              />
              <div className="from-background/80 to-background/20 pointer-events-none absolute inset-0 bg-gradient-to-t"></div>
            </div>
          </div>
        </div>
      </div>
